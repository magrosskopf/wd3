...
<script>
  ...
  const data = {
    ...
    plotOptions: {
      ...
      bar: {
        dataLabels: {
          ...
          useHTML: true,
          formatter: function() {
            return '<p style="margin: -15px 0 0 -12px;">' + this.point.y + '</p>' + '<div style="width: 10px; height: 10px; border-radius: 5px; background-color: white; margin: 0 0 0 -10px;"></div>';
          }
        }
      }
    },
    ...
    series: [{
        data: [56,54,50,46,46,42,38,36,35,35,25]
    }]
  }
